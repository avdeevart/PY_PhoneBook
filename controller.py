# Разработал: Артем Анатольевич Авдеев
# `controller.py` - модуль, отвечающий за управление данными и координацию между моделью и представлением.
# Он содержит основную функцию программы, которая запускает цикл обработки действий пользователя.
