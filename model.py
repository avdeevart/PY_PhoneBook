# Разработал: Куликовских Юлия Валентиновна
# 'model.py' - модуль, отвечающий за модель данных и операции с ними. Он содержит функции для работы 
# с данными контактов, включая загрузку контактов из CSV-файла, сохранение контактов в CSV-файл и 
