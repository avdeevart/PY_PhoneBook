# Выводит контакты на экран. Принимает список контактов в качестве параметра. Ничего не возвращает.
...
# Добавляет новый контакт. Принимает список контактов в качестве параметра. Ничего не возвращает.
...
# Редактирует контакт. Принимает список контактов и ключевое слово в качестве параметров. Ничего не возвращает.
def edit_contact(contacts, keyword):
    ...
    if not found_contacts:
        ...
        new_last_name = input("Введите новую фамилию (оставьте пустым если без изменений): ")
        new_first_name = input("Введите новое имя (оставьте пустым если без изменений): ")
        new_patronymic = input("Введите новое отчество (оставьте пустым если без изменений): ")
        new_phone_number = input("Введите новый номер телефона (оставьте пустым если без изменений): ")
...
# Удаляет контакт. Принимает список контактов и ключевое слово в качестве параметров. Ничего не возвращает.
